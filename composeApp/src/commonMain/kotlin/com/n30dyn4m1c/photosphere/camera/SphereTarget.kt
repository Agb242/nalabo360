...
data class SphereTarget(
    ...
    init {
        val yaw = toRadiansSafe(yawDegrees.toDouble())
        val elevation = toRadiansSafe(elevationDegrees.toDouble())
...
data class SphereTargetPlan(
    ...
    companion object {
        ...
        private fun ringYaws(
            ...
            val shrink = cos(toRadiansSafe(elevationDegrees.toDouble())).toFloat()
